...
public class TestCaseReportsPageWriter extends ReportsPage {
	...
	public static void header(PrintWriter paramPrintWriter, ITestResult paramITestResult) {
		paramPrintWriter.println(
				"<!DOCTYPE html>\n\n<html>\n    <head>\n        <title>Pie Charts</title>\n\n        <link rel=\"stylesheet\" type=\"text/css\" href=\"../"
						...
						+ "        <script language=\"javascript\" type=\"text/javascript\" src=\"../"
						+ getTestCaseHTMLPath(paramITestResult)
						+ "HTML_Design_Files/JS/pieChart.js\"></script>\n"
	...
	public void content(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
  {
	    ...
	    HTMLDesignFilesJSWriter.pieChartJS1(passedSize,failedSize ,
				    		skippedSize, paramITestResult);
			
  
  paramPrintWriter.println("<td id=\"content\">   \n                    <div class=\"info\">\n       TestCase Name: <b>" + paramITestResult.getName() + "</b><br/>" + "                        Time Taken for Executing: <b>" + getExecutionTime(paramITestResult) + "</b> <br/>\n" + "                        Current Run Number: <b>Run " + paramInt + "</b></br>\n"   + "                    </div>");
 // paramPrintWriter.println("<div class=\"info\"><br/><b>Requirement Coverage/ TestCase Description</b><br/><br/>" + getReqCoverageInfo(paramITestResult) + "</div>");
  paramPrintWriter.println("<div class=\"chartStyle summary\" style=\"background-color:#dbae0f;width: 26%; height: 200px;\">          \n                        <b>Execution Platform Details</b><br/><br/>\n                        <table>\n                            <tr>\n                                <td>O.S</td>\n                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n                                <td>" + Platform.OS + ", " + Platform.OS_ARCH + "Bit, v" + Platform.OS_VERSION + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Java</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Platform.JAVA_VERSION + "</td>\n" + "                            </tr>\n" + "\n" + "                            <tr>\n" + "                                <td>Hostname</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Platform.getHostName() + "</td>\n" + "                            </tr>\n" + "\n" + "                            <tr>\n" + "                                <td>Appium</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Platform.DRIVER_VERSION + "</td>\n" + "                            </tr>\n" + "                        </table>  \n" + "                    </div>\n" + "                   ");
  paramPrintWriter.println(" <div class=\"chartStyle summary\" style=\"background-color:#03b78a; margin-left: 40px; height: 200px;width: 26%; \">\n" + "                        <b>Summary</b><br/><br/>\n" + "                        <table>\n" + "                            <tr>\n" + "                                <td>Status</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + getResult(paramITestResult) + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Execution Date</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Utils1.getCurrentTime() + "</td>\n" + "                            </tr>\n" + "                            \n" + "\n" + "                            <tr>\n" + "                                <td>Browser</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" +browserName+ "</td>\n" + "                            </tr>\n" + "                        </table> \n" + "                    </div>");
  paramPrintWriter.println(" <div class=\"chartStyle summary\" style=\"background-color:#3B9C9C; margin-left: 40px; height: 200px;width: 26%; \">\n" + "                        <b>Results Summary</b><br/><br/>\n" + "                        <table>\n" + "                            <tr>\n" + "                                <td>Total Steps </td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + totalSteps + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Pass Count</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + passedSize + "</td>\n" + "                            </tr>\n" + "                            \n" + "\n" + "                            <tr>\n" + "                                <td>Fail Count </td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" +failedSize+ "</td>\n" + "                            </tr>\n" + "                        </table> \n" + "                    </div>");
  paramPrintWriter.println(" <div class=\"chartStyle\" style=\"text-align: left;margin-left: 50px;float: left;width: 80%;\">" + "                            <div id=\"chart\" style=\"height:300px;color:black;\"></div>\n" + "                        </div>\n" );
    ...
    if (paramITestResult.getStatus() != 3)
    {
      ...
      i = 1;
      String str = "config";//new line for filter
      ...
      //new lines for filter
        ...
        paramPrintWriter.print("<tr class=\"all " + str + "\">");// modified for filter
        paramPrintWriter.println("<td>" + i + "</td>");
       ...
       // paramPrintWriter.println("<td>" + localSteps.getExpectedValue() + "</td>");
        ...
        paramPrintWriter.println("<td title='" + localSteps.getClassName() + "' >" + localSteps.getLineNum() + "</td>");// modified for to show the className
    ...
    if ((paramITestResult.getParameters().length > 0) || (paramITestResult.getStatus() == 3) || (paramITestResult.getStatus() == 2))
    {
      ...
      if (paramITestResult.getParameters().length > 0)
      {
        ...
        for (Object LocalObject : paramITestResult.getParameters())
          paramPrintWriter.print("Param: " + LocalObject.toString() + "<br/>");
      }
      if (paramITestResult.getStatus() == 3)
      {
