...
public class DASHPRO_GROUPED_COLUMN_TESTING extends Keywords{

	public void groupedColumn(WebDriver driver,int iteration, String Flag, boolean AllTestcase) {
		...
		//Iteration Inputs
		//Axes
		String Select_Axis_Same_Value=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Select_Axis_Same_Value");
		String X_Axis_dataType=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "X_Axis_dataType");
		String Select_X_Axis_Value=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Select_X_Axis_Value");
		String SelectGroupValue_Date=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "SelectGroupValue_Date");

		String Y_Axis_dataType1=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Y_Axis_dataType1");
		String Select_Y_Axis_Value1=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Select_Y_Axis_Value1");
		String Y_Axis_dataType2=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Y_Axis_dataType2");
		String Select_Y_Axis_Value2=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Select_Y_Axis_Value2");
		String Y_Axis_dataType3=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Y_Axis_dataType3");
		String Select_Y_Axis_Value3=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Select_Y_Axis_Value3");
		String ChartTitle_Name=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChartTitle_Name");

		//Axis Title Input
		String Change_X_Title_Name=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_X_Title_Name");
		String Change_Y_Title_Name=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_Y_Title_Name");
		String ChangeFontFamily_AxisTitle=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeFontFamily_AxisTitle");
		String ChangeTitleFontSize_AxisTitle=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeTitleFontSize_AxisTitle");
		String Change_X_label_FontSize=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_X_label_FontSize");
		String Change_Y_label_FontSize=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_Y_label_FontSize");
		String X_Rotation_Input=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "X_Rotation_Input");
		String Y_Rotation_Input=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Y_Rotation_Input");

		//Chart title
		String TypeBackgroundColor1=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "TypeBackgroundColor1");
		String TypeTextColor1=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "TypeTextColor1");
		String Change_FontFamily_ChartTitle=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_FontFamily_ChartTitle");
		String ChangeFontSize_ChartTitle=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeFontSize_ChartTitle");
		String ChangeChartTitleName=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeChartTitleName");
		
		//Chart Style
		String Change_ChartTheme_ChartStyle=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_ChartTheme_ChartStyle");
		String Change_X_Label_Position_Style=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_X_Label_Position_Style");
		String Change_Grid_Distance=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_Grid_Distance");

		//Data Label
		String ChangeFontSizeValue_DataLabel=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeFontSizeValue_DataLabel");
		String ChangeRoundOffValue_DataLabel=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeRoundOffValue_DataLabel");
		String ChangeRotataionVal_Positive_DataLabel=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeRotataionVal_Positive_DataLabel");
		String ChangeRotataionVal_Negative_DataLabel=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeRotataionVal_Negative_DataLabel");
				
		//Legends
		String Legends_Color_Exp=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "LegendsColor_Exp");
		String DefaultLegend_Position=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "DefaultLegend_Position");
		String Change_LegendPositon=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_LegendPositon");
		String Default_Legend_FontSize=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Default_Legend_FontSize");
		String Change_Legend_FontSize=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Change_Legend_FontSize");
			
		//Others
		String ChangeStatsLine_Color=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeStatsLine_Color");
		String ChangeRoundOff_StatsLine=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "ChangeRoundOff_StatsLine");
		String Custom_StatsLine_Input=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "Custom_StatsLine_Input");
		String SelectStatsLine_Column=Utils.getDataFromTestDataIteration(iteration,"GROUPED_Column_Widget_Input", "SelectStatsLine_Column");
		...
		mouseOverToElement(driver, ADDTabPlus);
  	    ...
  	    wait(driver,"1");
  	    sendKeys(driver,newlyAddedTab,"GroupedColumnTestTab1");
		...
		setTestCaseID("TC_GROUP_COL_AXES_001");
		waitForElement(driver,Grouped_Column_widget);
		verifyElementDisplayed(driver, Grouped_Column_widget);
		setTestCaseID("TC_GROUP_COL_AXES_002");
		WidgetValidation(driver,Grouped_Column_widget,"Grouped Column");
		setTestCaseID("TC_GROUP_COL_AXES_004");
		click(driver,Grouped_Column_widget);
		elementnotvisible(driver, Loading);
		elementnotvisible1(driver, RPE_Loading);
		setTestCaseID("TC_GROUP_COL_AXES_003");
		String widgetValue=getText1(driver,WidgetValue);
	 	if(widgetValue.equals("Grouped Column")) {
			pass(driver,"Grouped Column displayed as the selected Widget ");
	 	}else {
	 		fail(driver,"Grouped Column not displayed as the selected Widget ");
	 	}
		
		setTestCaseID("TC_GROUP_COL_AXES_005");
		...
		setTestCaseID("TC_GROUP_COL_AXES_007");
		...
		setTestCaseID("TC_GROUP_COL_AXES_006");
		...
		setTestCaseID("TC_GROUP_COL_AXES_008");
		...
		if(isDisplayed(driver,X_Axis_dropdownResultsExp)) {
			...
			setTestCaseID("TC_GROUP_COL_AXES_012");
			...
			setTestCaseID("TC_GROUP_COL_AXES_009");
			...
			setTestCaseID("TC_GROUP_COL_AXES_010");
			...
			setTestCaseID("TC_GROUP_COL_AXES_017");
			ScrollBarValidation1(driver,X_Axis_dropdownResultsExp,"X-Axis");
			setTestCaseID("TC_GROUP_COL_AXES_019");
			...
			if(verifyElementDisplayed(driver, dropdownInputsearchBox)) {
				...
				if(firstValue_X.contains(Select_Axis_Same_Value)) {
					...
					if(isDisplayed2(driver,X_Axis_dropdownResultsExp)) {
						...
						setTestCaseID("TC_GROUP_COL_AXES_014");
		...
		setTestCaseID("TC_GROUP_COL_AXES_018");
		...
		setTestCaseID("TC_GROUP_COL_AXES_020");
		...
		setTestCaseID("TC_GROUP_COL_AXES_040");
		scrollUsingElement(driver, ApplyButton);
		click(driver,ApplyButton);
		if(isDisplayed(driver,ApplyError1)) {
		...
		setTestCaseID("TC_GROUP_COL_AXES_022");
		...
		if(isDisplayed(driver,Y_Axis_DropdownExpand)) {
			...
			if(isDisplayed(driver,Cate_agg_fieldSortValue)) {
				setTestCaseID("TC_GROUP_COL_AXES_043");
...
//		    	}
	    	 ...
	    	 if(isDisplayed(driver,Num_agg_fieldSortValue)) {
	    		 setTestCaseID("TC_GROUP_COL_AXES_042");
...
//		     	 }
	    	 ...
	    	 setTestCaseID("TC_GROUP_COL_AXES_026");
			List<WebElement> displayedDataImage=getWebElements(driver, dataTypeImages);
			List<WebElement> AvailableColumnList=getWebElements(driver, AvailableList);
			...
			setTestCaseID("TC_GROUP_COL_AXES_023");
			for(WebElement dataImag:displayedDataImage) {
				String dataTypeDisplay=dataImag.getAttribute("src");
				if(dataTypeDisplay.contains("Date") || dataTypeDisplay.contains("Categorical") || dataTypeDisplay.contains("Numerical") || dataTypeDisplay.contains("Text")) {
			...
			setTestCaseID("TC_GROUP_COL_AXES_024");
			if(isDisplayed2(driver,CategoricalColumnAxisDropdown)) {
				String Categorical1=getText1(driver,CategoricalColumnAxisDropdown);
				if(Categorical1.contains("(")) {
			...
			setTestCaseID("TC_GROUP_COL_AXES_036");
			...
			setTestCaseID("TC_GROUP_COL_AXES_035");
			...
			setTestCaseID("TC_GROUP_COL_AXES_025");
			if(verifyElementDisplayed(driver, dropdownInputsearchBox)) {
				setTestCaseID("TC_GROUP_COL_AXES_030");
				sendKeys(driver,dropdownInputsearchBox,"afghjku");
				if(isDisplayed2(driver,NoResultsFound)) {
				...
				setTestCaseID("TC_GROUP_COL_AXES_029");
				sendKeys(driver,dropdownInputsearchBox,Select_Axis_Same_Value);
				...
				if(firstValue_Y.contains(Select_Axis_Same_Value)) {
					...
					action.sendKeys(Keys.ENTER).build().perform();
					wait(driver,"1");
					setTestCaseID("TC_GROUP_COL_AXES_027");
					if(isDisplayed(driver,Selected_Y_Axis_Value)) {
						...
						setTestCaseID("TC_GROUP_COL_AXES_034");
						...
						setTestCaseID("TC_GROUP_COL_AXES_032");
						click(driver,Y_Axis_Input_Group);
						...
						setTestCaseID("TC_GROUP_COL_AXES_038");
						scrollUsingElement(driver, ApplyButton);
						click(driver,ApplyButton);
						...
						setTestCaseID("TC_GROUP_COL_AXES_039");
						scrollUsingElement(driver, ApplyButton);
						click(driver,ApplyButton);
						if(isDisplayed(driver,ApplyError1)) {
			...
			setTestCaseID("TC_GROUP_COL_AXES_031");
			click(driver,Y_Axis_Input_Group);
			waitForElement(driver,Y_Axis_DropdownExpand);
			ScrollBarValidation1(driver,Y_Axis_DropdownExpand,"Y-Axis");
			
			
			setTestCaseID("TC_GROUP_COL_AXES_041");
		...
		if(X_Axis_dataType.equals("Date")) {
			setTestCaseID("TC_GROUP_COL_AXES_055");
		...
		if(isDisplayed(driver,Y_Axis_DropdownExpand)) {
			if(isDisplayed(driver,NumericalColumnOption)) {
				...
				setTestCaseID("TC_GROUP_COL_AXES_044");
				if(isDisplayed(driver,GroupInput_Numeric)) {
					...
					if(isDisplayed(driver, GroupDropdown_Numeric_Expand)) {
						...
						for(WebElement AvailableColumn:AvailableColumnList) {
							...
							setTestCaseID("TC_GROUP_COL_AXES_050");
							if(columnNum>15) {
						...
						setTestCaseID("TC_GROUP_COL_AXES_052");
						...
						setTestCaseID("TC_GROUP_COL_AXES_047");
						click(driver,GroupInput_Numeric);
						waitForElement(driver, GroupDropdown_Numeric_Expand);
						...
						setTestCaseID("TC_GROUP_COL_AXES_049");
						mouseOverAndClick(driver, SecondValue);
						if(isDisplayed2(driver,GroupDropdown_Numeric_Expand)) {
							fail(driver,"Group dropdown not closed after selecting the value");
						}else {
		...
		setTestCaseID("TC_GROUP_COL_AXES_056");
		int numCount=0;
		...
		setTestCaseID("TC_GROUP_COL_AXES_053");
		if(numCount>1) {
		...
		setTestCaseID("TC_GROUP_COL_AXES_054");
        ...
        // *********** AxisTitle Validation Start *************
     		String Grouped_Column_Axis_Title= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_Axis_Title",Flag);
     	   
     	 	if(Grouped_Column_Axis_Title.equals("Yes") && AllTestcase==true) {
     	 		setTestCaseID("TC_GROUP_COL_AXIS_001");
     	      	...
     	      	setTestCaseID("TC_GROUP_COL_AXIS_002");
     	      	...
     	      	setTestCaseID("TC_GROUP_COL_AXIS_003");
     	  		...
     	  		setTestCaseID("TC_GROUP_COL_AXIS_004");
     	      	...
     	      	setTestCaseID("TC_GROUP_COL_AXIS_005");
     	     	String fontFamily_Value=getText1(driver,fontFamily_dropdown);
     	     	...
     	     	if(isDisplayed(driver,fontFamily_DropdownExpand)) {
     	    		...
     	    		setTestCaseID("TC_GROUP_COL_AXIS_007");
     	    		ScrollBarValidation1(driver,fontFamily_DropdownExpand,"Font Family");
     	    		setTestCaseID("TC_GROUP_COL_AXIS_008");
     	    		...
     	    		//setTestCaseID("");
     	    		setTestCaseID("TC_GROUP_COL_AXIS_006");
     	     	...
     	     	setTestCaseID("TC_GROUP_COL_AXIS_010");
     	       ...
     	       setTestCaseID("TC_GROUP_COL_AXIS_011");
     	       	click(driver,titleFontSizeDropdown);
     	       setTestCaseID("TC_GROUP_COL_AXIS_014");
     	  		...
     	  		setTestCaseID("TC_GROUP_COL_AXIS_015");
     	        ...
     	        setTestCaseID("TC_GROUP_COL_AXIS_016");
     	       	click(driver,X_axisFontSizeDropdown);
     	       setTestCaseID("TC_GROUP_COL_AXIS_019");
     	     	...
     	     	setTestCaseID("TC_GROUP_COL_AXIS_020");
     	        ...
     	        setTestCaseID("TC_GROUP_COL_AXIS_021");
     	        click(driver,Y_axisFontSizeDropdown);
     	        setTestCaseID("TC_GROUP_COL_AXIS_024");
     	       ...
     	       setTestCaseID("TC_GROUP_COL_AXIS_026");
     	        ...
     	        setTestCaseID("TC_GROUP_COL_AXIS_027");
     			...
     			setTestCaseID("TC_GROUP_COL_AXIS_029");
     	      ...
     	      //waitForElement(driver, ChartBarDisplayCount);
     	     	 setTestCaseID("TC_GROUP_COL_AXIS_028");
     	     	...
     	     	setTestCaseID("TC_GROUP_COL_AXIS_030");
     			...
     			for(WebElement ele:moveElements) {
     	  		...
     	  		setTestCaseID("TC_GROUP_COL_AXIS_032");
     	     	...
     	     	setTestCaseID("TC_GROUP_COL_AXIS_031");
     	     	...
     	     	setTestCaseID("TC_GROUP_COL_AXIS_033");
	     	...
	     	// ******************** ChartTitle Validation Start *******************
	         	 String Grouped_Column_Chart_Title= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_Chart_Title",Flag);
	           if(Grouped_Column_Chart_Title.equals("Yes") && AllTestcase==true) {
	        ...
	        //********** ChartStyle Validation Start *************************
   	    	...
   	    	setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_001");
   	    	verifyElementDisplayed(driver,Chart_FormatSec);
   			click(driver,Chart_FormatSec);
	   		
        	 String Grouped_Column_ChartFormat_Chart_Style= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_ChartFormat_Chart_Style",Flag);
             if(Grouped_Column_ChartFormat_Chart_Style.equals("Yes")&&AllTestcase==true) {
            	 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_002");
        		 String ChartFormatOpenstatus=getAttribute1(driver, chartFormatExpand, "class");
	   	  		 ...
	   	  		 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_003");
	    			 ...
	    			 if(ChartStylingColor_Exp.equalsIgnoreCase(ChartStylingColor_Act)) {
	    	  		 ...
	    	  		 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_004");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_005");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_006");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_007");
	     			 ...
	     			 if(verifyElementDisplayed(driver,ChartThemeResults)) {
	     				 ...
	     				 wait(driver,"1");
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_010");
	     				 ...
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_011");
	     				 ...
	     				 int beforeSearchSize=beforeSearchResults.size();
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_008");
	     				 verifyElementIsPresent1(driver,dropdownInputsearchBox);
	     				 click(driver,dropdownInputsearchBox);
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_009");
	     				 ...
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_013");
	     				...
	     				setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_012");
	     				click(driver,ChartThemeInput);
	     			...
	     			String X_Selected=getText1(driver,X_Axis_Input);
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_014");
	     			 if(isToggleEnable(driver,AutoScroll_toggle)) {
	     				 ...
	     				 if(isToggleEnable(driver,X_Scroll_toggle)) {
	     					 fail(driver,"X Scroll toggle not disabled when AutoScroll toggle is enabled for the X Value : "+X_Selected);
	     				 }else {
	     					 pass(driver,"X Scroll toggle disabled when AutoScroll toggle is enabled");
	     				 }
	     			  		   
	     				 if(isToggleEnable(driver,Y_Scroll_toggle)) {
	     					 fail(driver,"Y Scroll toggle not disabled when AutoScroll toggle is enabled for the Y_Value : "+Select_Y_Axis_Value1+", "+Select_Y_Axis_Value2+", "+Select_Y_Axis_Value3);
	     				 }else {
	     					 pass(driver,"Y Scroll toggle disabled when AutoScroll toggle is enabled for the Y_Value : "+Select_Y_Axis_Value1+", "+Select_Y_Axis_Value2+", "+Select_Y_Axis_Value3);
	     				 }
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_016");
	     			...
	     			setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_018");
	     			 if(isToggleEnable(driver,EnableGrid_toggle)) {
	     				 ...
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_019");
	     				 ...
	     				 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_020");
	     				 scrollUsingElement(driver, ApplyButton);
	     	  			 click(driver,ApplyButton);
	     	  			 elementnotvisible1(driver, Loading);
	     	  			 elementnotvisible1(driver, RPE_Loading);
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_021");
	     			...
	     			setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_022");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_023");
	     			 click(driver,X_Label_Position_Input);
	     			
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_024");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_027");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_028");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_029");
	     			 click(driver,Grid_Distance_Input);
	     			 
	     			 selectByText(driver, Grid_Distance_Input, Change_Grid_Distance);
	     			 wait(driver,"1");
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_030");
	     			 ...
	     			 setTestCaseID("TC_GROUPED_COLUMN _CHART_STYLE_031");
             ...
             String Grouped_Column_ChartFormat_Data_Labels= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_ChartFormat_Data_Labels",Flag);
             if(Grouped_Column_ChartFormat_Data_Labels.equals("Yes") && AllTestcase==true) {
            	 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_001");
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_002");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_003");
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_004");
         	     if(isToggleEnable(driver,EnableValue_Input)) {
         	  		 ...
         	  		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_005");
         	     ...
         	     //All options are inaccessible when the enable value toggle is disabled. Validation end
         	     setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_006");
         		...
         		// waitForElement(driver, ChartBarDisplayCount);/
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_007");
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_008");
         		 String defaultFormatValue_Act=defaultSelectedValue(driver, ValueFormatInput);
           		...
           		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_009");
           		...
           		verifyElementIsPresent1(driver, Percentage_ValueFormat);
           		 ...
           		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_010");
         		...
         		// waitForElement(driver, ChartBarDisplayCount);
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_011");
         		 selectOptionValue(driver,ValueFormatInput,"percentage");
         		 wait(driver,"1");
         		 scrollUsingElement(driver, ApplyButton);
         		 click(driver,ApplyButton);
         		 elementnotvisible1(driver, RPE_Loading);
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_016");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_013");
         		 selectOptionValue(driver,ValueFormatInput,"value");
         		 scrollUsingElement(driver, ApplyButton);
         		 click(driver,ApplyButton);
         		 elementnotvisible1(driver, RPE_Loading);
         		 ...
         		 setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_012");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_014");
...
//         		 //new
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_015");
         		click(driver,SeperatorInput);
         		selectOptionValue(driver,SeperatorInput,"#,##");
         		scrollUsingElement(driver, ApplyButton);
         		click(driver,ApplyButton);
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_017");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_018");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_019");
         		click(driver,ValueFontSizeInput);
         		
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_022");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_023");
         		String defaultRoundOffValue_Act=defaultSelectedValue(driver, RoundOffValueInput);
          		...
          		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_024");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_025");
         	   ...
         	   setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_027");
...
//         	   }
         	  ...
         	  setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_028");
...
//       	   }
         	   ...
         	   // position check end
 	      	   ...
 	      	   setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_029");
...
// 	      	   }
 	      	   ...
 	      	   wait(driver,"1");
 	      	   chartValuePositionAct=validateElementPosition(driver,charts_Bar,EnableValue,"center");
 	      	   if(chartValuePositionAct==true) {
 	      	   	...
 	      	   	setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_031");
         	    selectOptionValue(driver,SeperatorInput,"#,###");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_032");
         		selectOptionValue(driver,ValueFormatInput,"percentage");
         		scrollUsingElement(driver, ApplyButton);
         		click(driver,ApplyButton);
         		elementnotvisible1(driver, RPE_Loading);
         	   ...
         	   setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_033");
         	    selectOptionValue(driver,ValueFormatInput,"value");
         	    scrollUsingElement(driver, ApplyButton);
         	    click(driver,ApplyButton);
         	    elementnotvisible1(driver, RPE_Loading);
         	   ...
         	   // waitForElement(driver, ChartBarDisplayCount);
         	    ...
         	    setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_034");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_035");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_036");
         		...
         		setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_037");
              ...
              //	waitForElement(driver, ChartBarDisplayCount);
              	...
              	setTestCaseID("TC_GROUPED_COLUMN _DATA_LABEL_038");
           ...
           // ******************** Legend Validation Start **********************//
  			 String Grouped_Column_ChartFormat_Legends= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_ChartFormat_Legends",Flag);
  	         if(Grouped_Column_ChartFormat_Legends.equals("Yes")&&AllTestcase==true) {
  	        	 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_001");
  	    		 ...
  	    		 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_002");
  	    		 ...
  	    		 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_003");
  	    		 ...
  	    		 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_004");
  	    		 ...
  	    		 if(isToggleEnable(driver, Legend_Input)) {
  	    			...
  	    			setTestCaseID("TC_GROUPED_COLUMN _LEGEND_007");
  	    			 if(IsElementEnabled(driver, LegendPosition_Input)) {
  	    				 pass(driver,"Legend Position Input is Accessible when the Legend Toggle is Enable");
  	    				 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_008");
  	    				...
  	    				setTestCaseID("TC_GROUPED_COLUMN _LEGEND_009");
  	    			 ...
  	    			 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_013");
  	    			 if(IsElementEnabled(driver, LegendFontSize_Input)) {
  	    				 pass(driver,"Legend FontSize Input is Accessible when the Legend Toggle is Enable");
  	    				 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_012");
  	    				...
  	    				setTestCaseID("TC_GROUPED_COLUMN _LEGEND_016");
  	    		 ...
  	    		 setTestCaseID("TC_GROUPED_COLUMN _LEGEND_017");
  	       ...
  	       // ******************* Others Validation Start *********************
				 String Grouped_Column_ChartFormat_Others= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_ChartFormat_Others",Flag);

		         if(Grouped_Column_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
		        	 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_001");
		    		 ...
		    		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_002");
		    		 ...
		    		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_003");
		    		 ...
		    		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_004");
		    		 String default_StatslineValueAct=defaultSelectedValue(driver, StatsLine_Input);
		      		 if(default_StatslineValueExp.equals(default_StatslineValueAct)) {
		    	  		...
		    	  		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_005");
		      		 ...
		      		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_006");
		      		 ...
		      		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_008");
		      		...
		      		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_009");
		      		scrollUsingElement(driver, ApplyButton);
      	  		click(driver,ApplyButton);
      	  		...
      	  		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_010");
      	  	    ...
      	  	    setTestCaseID("TC_GROUPED_COLUMN _OTHERS_011");
      	  	    ...
      	  	    setTestCaseID("TC_GROUPED_COLUMN _OTHERS_012");
      	  	    selectOptionValue(driver,StatsLineColumnInput,SelectStatsLine_Column);
      	  	    
      	  	    	 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_013");
		      		 click(driver,StatsLine_Input);
		      		...
		      		click(driver,ApplyButton);
		      		elementnotvisible1(driver, RPE_Loading);
		      		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_020");
		      		if(isDisplayed(driver, statsLineColorInput)) {
		    	  		...
		    	  		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_021");
		    	  		 ...
		    	  		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_022");
		    	  		 ...
		    	  		 verifyElementDisplayed(driver,Chart_Section);
		    	  		 waitForElement(driver, ChartBarDisplayCount);
		    	  		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_023");
		      		...
		      		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_015");
		      		...
		      		if(isToggleAccessible(driver,statsLinePosition_Input)) {		
		      		 ...
		      		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_014");
		      		 ...
		      		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_016");
		    		 ...
		    		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_018");
		    		 //RoundOff Validation Start
		      		 ...
		      		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_017");
		     		 ...
		     		 setTestCaseID("TC_GROUPED_COLUMN _OTHERS_019");
		     	...
		     	setTestCaseID("TC_GROUPED_COLUMN _OTHERS_024");
		     	 //cursor validation start....
		   		...
		   		if(isToggleEnable(driver,Cursor_Input)) {		
		   		 ...
		   		 //cursor validation End....
		   		 	...
		   		 	setTestCaseID("TC_GROUPED_COLUMN _OTHERS_027");
		    		...
		    		waitForElement(driver, ChartBarDisplayCount);
		      		...
		      		setTestCaseID("TC_GROUPED_COLUMN _OTHERS_028");
