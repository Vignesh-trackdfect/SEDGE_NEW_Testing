...
public class DASHPRO_GANTT_TESTING extends Keywords {
	...
	public void gantt_widget_testing(WebDriver driver,int iteration,String Flag,boolean AllTestcase) {
		...
		if(!isDisplayed(driver,error)) {
			...
			setTestCaseID("");
     		String Gantt_Axis_Title= getCellValue("TestExecution","Testcase_Selection","Gantt_Axis_Title",Flag);
     	 	if(Gantt_Axis_Title.equals("Yes") && AllTestcase==true) {
           ...
           if(Gantt_Chart_Title.equals("Yes") && AllTestcase==true) {
          ...
          // ******************** ChartTitle Validation End *******************
           ...
           //********** ChartStyle Validation Start *************************
            ...
            if(Gantt_ChartFormat_Chart_Style.equals("Yes")&&AllTestcase==true) {
            ...
            if(Gantt_ChartFormat_Data_Label.equals("Yes") && AllTestcase==true) {
           	     setTestCaseID("");
            ...
            if(Gantt_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
        	   	setTestCaseID("");
