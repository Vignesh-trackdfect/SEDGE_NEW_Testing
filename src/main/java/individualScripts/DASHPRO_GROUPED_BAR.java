...
public class DASHPRO_GROUPED_BAR extends Keywords{
	...
	public void groupedBarwidgetTest(WebDriver driver,int iteration,String Flag,boolean AllTestcase) throws Exception {
...
//		wait(driver,"1");
        ...
        // *********** AxisTitle Validation Start *************
     		...
     		String Grouped_Bar_Axis_Title= getCellValue("TestExecution","Testcase_Selection","Grouped_Bar_Axis_Title",Flag);
     	 	...
     	 	if(Grouped_Bar_Axis_Title.equals("Yes") && AllTestcase==true) {
     	 		setTestCaseID("TC_GROUP_BAR_056");
...
//     			}
	     	...
	     	// ******************** ChartTitle Validation Start *******************
	           ...
	           if(Grouped_Bar_Chart_Title.equals("Yes") && AllTestcase==true) {
            ...
            if(Grouped_Bar_Chart_Style.equals("Yes")&&AllTestcase==true) {
            ...
            if(Grouped_Bar_Data_Labels.equals("Yes") && AllTestcase==true) {
...
//	      	   }
  	      ...
  	      // ******************** Legend Validation Start **********************//
  	         ...
  	         if(Grouped_Bar_Legends.equals("Yes")&&AllTestcase==true) {
  			...
  			// ******************* Legends Validation End *********************
  		      ...
  		      // ******************* Others Validation Start *********************
  		        ...
  		        if(Grouped_Bar_Others.equals("Yes") && AllTestcase==true) {
