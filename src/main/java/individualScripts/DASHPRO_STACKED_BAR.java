...
public class DASHPRO_STACKED_BAR extends Keywords{
	...
	public void StackedBarwidgetTest(WebDriver driver,int iteration,String Flag,boolean AllTestcase) throws Exception {
...
//        System.out.println("Y_Selected : "+Y_Selected);
     ...
     // *********** AxisTitle Validation Start *************
         ...
         if(Stacked_Bar_AxisTitle.equals("Yes") && AllTestcase==true) {
        ...
        // ******************** ChartTitle Validation Start *******************
         ...
         if(Stacked_Bar_ChartTitle.equals("Yes") && AllTestcase==true) {
        ...
        //********** ChartStyle Validation Start *************************
         ...
         if(Stacked_Bar_ChartFormat_ChartStyle.equals("Yes")&&AllTestcase==true) {
         ...
         if(Stacked_Bar_ChartFormat_DataLabel.equals("Yes") && AllTestcase==true) {
...
//    		 }
		...
		// ******************** Legend Validation Start **********************//
         ...
         if(Stacked_Bar_ChartFormat_Legend.equals("Yes")&&AllTestcase==true) {
		...
		// ******************* Others Validation Start *********************
         ...
         if(Stacked_Bar_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
