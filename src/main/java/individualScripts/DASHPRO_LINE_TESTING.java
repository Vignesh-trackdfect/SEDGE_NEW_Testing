...
public class DASHPRO_LINE_TESTING extends Keywords{
	...
	public void line_widget_testing(WebDriver driver,int iteration,String Flag,boolean AllTestcase) {
        ...
        if(Line_Axis_Title.equals("Yes") && AllTestcase==true) {
...
// 			}
 	   ...
 	   // ******************** ChartTitle Validation Start *******************
	       ...
	       if(Line_Chart_Title.equals("Yes") && AllTestcase==true) {
       ...
       //********** ChartStyle Validation Start *************************
         ...
         if(Line_ChartFormat_Chart_Style.equals("Yes")&&AllTestcase==true) {
...
//    			 }
       ...
       // ********** DataLabel Validation Start ***************
         ...
         if(Line_ChartFormat_Data_Labels.equals("Yes") && AllTestcase==true) {
...
//     		 //new
         ...
         if(Line_ChartFormat_Legends.equals("Yes")&&AllTestcase==true) {
        	 setTestCaseID("");
		...
		// ******************* Legends Validation End *********************
         ...
         if(Line_ChartFormat_Deviations.equals("Yes") && AllTestcase==true) {
        	 if(X_Axis_dataType.equals("Date")) {
            		 ...
            		 boolean chartValuePositionAct=validateElementPosition2(driver,LineChart_Area,Deviation_Chart,"outside");
	 	   			 ...
	 	   			 if(chartValuePositionAct1==true) {
      	   			 ...
      	   			 if(deviationLast>deviationLastBefore) {
      	   				 ...
      	   				 if(percentColor.equalsIgnoreCase("#FFFF00")) {
         ...
         if(Line_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
        	 setTestCaseID("");
