...
public class DASHPRO_COLUMN_SMOKE_TESTING extends Keywords{
	...
	public void column_testing(WebDriver driver,int iteration,String Flag,boolean AllTestcase) {
...
//			
       ...
       // setTestCaseID("TC_COLUMN_049");
		...
		String Column_Axis_Title= getCellValue("TestExecution","Testcase_Selection","Column_Axis_Title",Flag);
	 	...
	 	if(Column_Axis_Title.equals("Yes") && AllTestcase==true) {
	   ...
	   // ******************** ChartTitle Validation Start *******************
        ...
        if(Column_Chart_Title.equals("Yes") && AllTestcase==true) {
	 ...
	 //********** ChartStyle Validation Start *************************
        ...
        if(Column_Chart_Style.equals("Yes")&&AllTestcase==true) {
      ...
      if(Column_Data_Labels.equals("Yes") && AllTestcase==true) {
...
//	   }
      ...
      if(Column_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
