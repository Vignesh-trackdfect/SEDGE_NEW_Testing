...
public class DASHPRO_TEXT_TESTING extends Keywords{
	...
	public void text_widget_testing(WebDriver driver,int iteration,String Flag,boolean AllTestcase) {
        ...
        if(Text_Chart_Title.equals("Yes") && AllTestcase==true) {
       ...
       // ******************** ChartTitle Validation End *******************
        ...
        if(Text_ChartFormat_As_Label.equals("Yes")&&AllTestcase==true) {
