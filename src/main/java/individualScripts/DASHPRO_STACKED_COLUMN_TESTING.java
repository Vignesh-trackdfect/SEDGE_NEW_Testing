...
public class DASHPRO_STACKED_COLUMN_TESTING extends Keywords {
	...
	public void stacked_column_testing(WebDriver driver,int iteration,String Flag,boolean AllTestcase) {
...
//		
		...
		if(Stacked_Column_Axis_Title.equals("Yes") && AllTestcase==true) {
...
//				}
	        ...
	        if(Stacked_Column_Chart_Title.equals("Yes") && AllTestcase==true) {
	     ...
	     //********** ChartStyle Validation Start *************************
			 ...
			 click(driver,Chart_FormatSec);
	       	 ...
	       	 if(Stacked_Column_ChartFormat_ChartStyle.equals("Yes")&&AllTestcase==true) {
//	         	
	         ...
	         if(Stacked_Column_ChartFormat_DataLabels.equals("Yes") && AllTestcase==true) {
...
//	    	   //setTestCaseID("TC_COLUMN_DATA_LABEL_028");
	      ...
	      // ******************** Legend Validation Start **********************//
	         ...
	         if(Stacked_Column_ChartFormat_Legend.equals("Yes")&&AllTestcase==true) {
	      ...
	      // ******************* Others Validation Start *********************
	         ...
	         if(Stacked_Column_ChartFormat_Others.equals("Yes") && AllTestcase==true) {
