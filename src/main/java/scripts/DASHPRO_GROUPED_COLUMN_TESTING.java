...
public class DASHPRO_GROUPED_COLUMN_TESTING extends Keywords{
	...
	public void groupedColumn(WebDriver driver,int iteration, String Flag) {
...
//		     	 }
        ...
        // *********** AxisTitle Validation Start *************
     		String Grouped_Column_Axis_Title= getCellValue("TestExecution","Testcase_Selection","Grouped_Column_Axis_Title",Flag);
     	 	...
     	 	if(Grouped_Column_Axis_Title.equals("Yes")) {
	     	...
	     	// ******************** ChartTitle Validation Start *******************
	           ...
	           if(Grouped_Column_Chart_Title.equals("Yes")) {
	        ...
	        //********** ChartStyle Validation Start *************************
             ...
             if(Grouped_Column_ChartFormat_Chart_Style.equals("Yes")) {
             ...
             if(Grouped_Column_ChartFormat_Data_Labels.equals("Yes")) {
...
// 	      	   }
           ...
           // ******************** Legend Validation Start **********************//
  	         ...
  	         if(Grouped_Column_ChartFormat_Legends.equals("Yes")) {
  	       ...
  	       // ******************* Others Validation Start *********************
		         ...
		         if(Grouped_Column_ChartFormat_Others.equals("Yes")) {
