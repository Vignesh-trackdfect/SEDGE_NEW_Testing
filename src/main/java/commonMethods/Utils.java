...
public class Utils {
	...
	public static void InputDataFileName(String file) {
		FileName = file;
	}
	...
	public static String getDataFromTestDataIteration(int Iteration,String autoTestCaseNameVal, String label) {
		String requiredCellVal = "";
		try {
			FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"/data/"+FileName+".xlsx");
			XSSFWorkbook wb = new XSSFWorkbook(fis);
			XSSFSheet ws = wb.getSheet("Iteration_"+Iteration);
			int rowNum = ws.getLastRowNum() + 1;
